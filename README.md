**Конспект: Материнская плата**

---

### **1. Определение и назначение**  
Материнская плата (англ. _Motherboard_) — это основная плата компьютера, которая обеспечивает связь между всеми компонентами системы.  
**Основные функции**:  
- Объединение процессора, памяти, видеокарты, накопителей и других устройств.  
- Распределение питания и данных между компонентами.  
- Обеспечение работы интерфейсов (USB, HDMI и др.).

---

### **2. Основные компоненты материнской платы**  
- **Сокет процессора**  
  Разъём для установки CPU (например, LGA 1700 для Intel или AM5 для AMD).  
- **Слоты оперативной памяти (RAM)**  
  Обычно 2–4 слота для модулей DDR4/DDR5.  
- **Чипсет**  
  Микросхема, управляющая взаимодействием компонентов (например, Intel Z790, AMD B650).  
- **Слоты расширения**  
  - PCI Express (x16 для видеокарт, x1 для других устройств).  
  - M.2 для SSD-накопителей.  
- **Порты ввода-вывода**  
  USB, HDMI, Ethernet, аудиоразъёмы и т.д.  
- **Разъёмы питания**  
  Основной 24-контактный и дополнительный для CPU.  
- **BIOS/UEFI**  
  Микропрограмма для настройки железа и загрузки системы.

---

### **3. Форм-факторы (типы плат)**  
- **ATX** (30.5 × 24.4 см) — стандартный размер для ПК, много слотов.  
- **Micro-ATX** (24.4 × 24.4 см) — компактнее, меньше слотов.  
- **Mini-ITX** (17 × 17 см) — для мини-ПК, ограниченная функциональность.  
- **Серверные платы** — большие, с поддержкой многопроцессорных систем.

---

### **4. Ключевые характеристики при выборе**  
- **Совместимость с процессором** (тип сокета).  
- **Поддержка памяти** (DDR4/DDR5, максимальный объём и частота).  
- **Количество слотов PCIe и M.2** — для видеокарт и SSD.  
- **Наличие современных интерфейсов** (USB 3.2, Wi-Fi 6, HDMI 2.1).  
- **Возможность разгона** (зависит от чипсета, например, Z790 для Intel).  
- **Система охлаждения** — радиаторы на чипсете и VRM (модуль питания).

---

### **5. Интересные факты**  
- BIOS постепенно заменяется на UEFI, который поддерживает мышь и работу с дисками >2 ТБ.  
- Чипсет влияет на количество USB-портов, SATA-разъёмов и поддержку RAID.  
- Материнские платы для ноутбуков часто интегрируют компоненты (видеокарту, звуковую карту).

---

**Итог**: Материнская плата — это «скелет» компьютера, от её характеристик зависит совместимость и производительность системы. При выборе важно учитывать форм-фактор, сокет, чипсет и необходимые интерфейсы.
